...
def hello(event, context):
    ...
    try:
        ...
        feelings = re.search(r"(?i)(?:i love (.+))([\s.!,]|$)", msg)
        ...
        b_r, dr_r, gr_r, te_r, p_r, despacito_r, despacito_r2 = None, None, None, None, None, None, None
        c_r, e_r, fe_r, t_r, q_r, ci_r, wildciats_r, seimei_r = None, None, None, None, None, None, None, None
        if drums:
        ...
        full_list = [ci_r, wildciats_r, te_r, b_r, dr_r, gr_r, c_r, q_r, e_r, fe_r, t_r, p_r, despacito_r, despacito_r2,
                     seimei_r]
